<template>
  <div class="page-item-wrap" ref="page-item-wrap" @mouseWheelHandle="onScroll">
    <main-header
      v-if="windowWid"
    ...
    <mobile-header
      ...
      :navState="navState"
    ></mobile-header>
    <section_1 class="section fullpage" ref="Home"></section_1>
    <section_2
...
export default {
  ...
  methods: {
    scrollInto(title) {
      this.$refs[title].$el.scrollIntoView({ behavior: 'smooth' })
    },
  },
  mounted() {
